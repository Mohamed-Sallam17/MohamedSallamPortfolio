        ...
        <div className="container mt-8">
            <div className='flex justify-center items-center flex-col' data-aos="fade-up">
                <div className="about-content w-full mx-auto text-center">
                    <span className="uppercase text-sm lg:text-lg text-(--primary) mb-4">about me</span>
                    <h4 className='text-xl md:text-3xl lg:text-5xl mb-8'>I build digital experiences <br /> that are 
                        <span className="text-(primary)"> fast, functional </span> 
                        and  
                        <span className="text-(primary)"> beautiful </span>
                    </h4>
                    <span className='text-(--text-muted) md:w-[70%] lg:w-[60%] xl:w-[40%] mx-auto inline-block text-sm'>
                ...
                <div className="dot-shape w-full text-center flex justify-center items-center my-8 relative">
                    ...
                    <span className='dot inline-block w-[20px] h-[20px] rounded-[50%] bg-[var(--primary)]'></span>
                </div>
                <div className="skills text-center w-full mt-8" id='skills' data-aos="fade-up">
                    <span className="uppercase text-sm lg:text-lg text-(--primary) mb-4">my skills</span>
                    <h4 className='text-xl md:text-2xl lg:text-4xl mb-8'> Technologies | <span className="text-(--primary)" > Work With </span></h4>
                        ...
                        <div className="marquee overflow-x-hidden relative">
                            <div className="marquee-track flex w-max gap-4 md:gap-8 lg:gap-15">
                                ...
                                [...skillsIcons,...skillsIcons,...skillsIcons,...skillsIcons,...skillsIcons,...skillsIcons].map((icon,index)=>(
                                    <div className="marquee-item p-2 rounded-xl border-2 border-(--border) bg-white w-[50px] h-[50px] md:w-[80px] md:h-[80px] flex justify-center items-center" key={index}>
