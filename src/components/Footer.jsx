    ...
    <footer className="mt-8" id="contact" data-aos="fade-up">
      <div className="container">
        <div className="contact-me w-full mx-auto text-center">
          ...
          <p className='text-(--desc-color) mx-auto text-[0.9rem]'>
        ...
        <div className="profiles flex items-center justify-center flex-wrap gap-4 mt-8">
          <a href="https://github.com/Mohamed-Sallam17" className="w-max bg-(--second-bg) p-4 rounded-2xl">
            <FaGithub className="text-2xl"/>
          </a>
          <a href="https://wa.me/+201006830249" className="w-max bg-(--second-bg) p-4 rounded-2xl">
      ...
      <div className="copyright mt-8 h-[80px] flex items-center justify-center bg-(--second-bg)">
